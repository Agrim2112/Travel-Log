      ...
      <div className="footer">
        <div className="compney-brief">
          <div className="footer-section about">
            ...
            <p>Tales that cover the entire World.</p>
          </div>
        ...
        <div className="footer-contacts">
          ...
          <div className="contact">
            <div className="contact-item">
              ...
              <span className="hover-text">+1 123 456 7890</span>
            </div>
            <div className="contact-item">
              <FontAwesomeIcon icon={faLocationPin} />
              <span className="hover-text">123 Main St, City, Country</span>
            </div>
            <div className="contact-item">
              <FontAwesomeIcon icon={faClock} />
              <span className="hover-text">Mon-Fri: 9am-5pm</span>
            </div>
          </div>
